...
{
    #ifdef isrUART_INTERRUPT_INTERRUPT_CALLBACK
        isrUART_Interrupt_InterruptCallback();
    #endif /* isrUART_INTERRUPT_INTERRUPT_CALLBACK */ 
...
void isrUART_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)isrUART__INTC_NUMBER] = address;
}
...
cyisraddress isrUART_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)isrUART__INTC_NUMBER];
}
...
*
*   Note calling isrUART_Start or isrUART_StartEx will 
*   override any effect this API would have had. This API should only be called
*   after isrUART_Start or isrUART_StartEx has been called. 
